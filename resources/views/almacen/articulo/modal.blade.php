<div class="modal fade modal-slide-in-rigth" aria-hidden="true" role="dialog" tabindex="1" id="modal-delete-{{$art->idarticulo}}">
	{{Form::Open(array('action'=>array('ArticuloController@destroy',$art->idarticulo),'method'=>'delete'))}}<!--creamos un array para que aparezca el eliminar para cada elemento de la lista, invocamos el metodo a través de destroy en la clase CategoriaController, le pasamos la idcategoria, el metodo delete llama la funcion eliminar de la clase-->
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Confirmé si es que quiere eliminar el artículo</p>
			</div>
