  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      Gabriel Arcos - Desarrollando Software
                      <small>www.facebook.com/gabriel.patton.valdivinos</small>
                    </p>
                  </li>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li>
              <a href="{{URL::action('PdfController@pdf_ayuda')}}">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="https://www.facebook.com/gabriel.patton.valdivinos">Gabriel Arcos</a>.</strong> All rights reserved.
      </footer>

      
    <!-- jQuery 2.1.4 -->
    <script src="{{asset('js/jQuery-2.1.4.min.js')}}"></script>
    @stack('scripts')<!--esto permite llamar desde otra plantilla el script, se coloca stack y cualquier nombre, en este caso se coloco scripts-->
    <!-- Bootstrap 3.3.5 -->
