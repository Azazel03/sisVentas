...
class ProveedorController extends Controller
{
    ...
    public function index(Request $request){
    	if($request){
    		...
    		return view('compras.proveedor.index',["personas"=>$personas,"searchText"=>$query]);//retorna una vista con los datos, en la ruta almacen/categoria/index, además a la vista se le envia ciertos paramnetros,searchText es el texto de busqueda
    	}
    }
    ...
    public function store(PersonaFormRequest $request){
    	$persona=new Persona;
    	$persona->tipo_persona='Proveedor';//no atrapa del formulario porque la persona siempre va ha ser un proveedor
    	...
    	return Redirect::to('compras/proveedor');//retorna a esta vista, que es el index de la vista persona
    }
    //function que sirve para mostrar datos, recibe el id de la categoria que se quiere mostrar
    public function show($id){
    	return view("compras.proveedor.show",["persona"=>Persona::findOrFail($id)]);//envia el parametro guardado en persona y retorna una vista con la categoria
    }

    public function edit($id){
    	return view("compras.proveedor.edit",["persona"=>Persona::findOrFail($id)]);//envia el parametro guardado en persona y retorna una vista con la categoria
    }
    ...
    public function update(PersonaFormRequest $request,$id){//recibe la llave primaria del dato que se quiere actualizar
    	...
    	return Redirect::to('compras/proveedor');//redirecciona a esta vista
    }
